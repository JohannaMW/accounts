...
urlpatterns = patterns('',
    ...
    url(r'^charts/expenses/choice/$', 'accounting.views.chart_exp_choice', name='chart_exp_choice'),
...
# charts
    ...
    url(r'^charts/income/choice/$', 'accounting.views.chart_inc', name='chart_inc_choice'),
